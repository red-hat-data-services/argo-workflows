...
<<<<<<<< HEAD:sdks/python/client/argo_workflows/model/io_argoproj_workflow_v1alpha1_node_flag.py
...
>>>>>>>> argo/release-3.6:sdks/python/client/argo_workflows/model/sleep_action.py
