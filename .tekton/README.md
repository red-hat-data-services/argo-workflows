...
To modify the pipelines for `argo-workflows` in the `rhoai-2.23-multi-arch-poc` release:
...
```bash
git commit -am "Update pipelinerun for argo-workflows (rhoai-2.23-multi-arch-poc)"
